			...
			<table class="table tabe-hover table-bordered" id="list">
				...
				<tbody>
					...
					<tr>
						...
						<td class="text-center">
		                    <div class="btn-group">
		                    	<button type="button" class="btn btn-info btn-flat view_parcel1" data-id="<?php echo $row['id'] ?>">
...
<script>
	$(document).ready(function(){
		$('#list').dataTable()
		$('.view_parcel1').click(function(){
			uni_modal("Parcel's Details","view_parcel1.php?id="+$(this).attr('data-id'),"large")
		})
